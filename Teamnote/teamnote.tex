...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[L]{SungKyunKwan University - Matt Watle}
\fancyhead[R]{\thepage}
\cfoot{}
...
\lstinputlisting[style=mycpp]{src/Heavy_Light_Decomposition.cpp}

\subsection{Centroid Decomposition}
\lstinputlisting[style=mycpp]{src/Centroid_Decomposition.cpp}
